namespace WebBanGear.Models
{
    public class Paginate
    {
        ...
        public Paginate(int totalItems, int page, int pageSize = 5) //5 items/trang
        {
            //làm tròn tổng items/5 items trên 1 trang VD:16 items/10 = tròn 3 trang
            int totalPages = (int)Math.Ceiling((decimal)totalItems / (decimal)pageSize); //10/5 = 2trang
